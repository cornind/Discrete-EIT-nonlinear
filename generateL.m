function [L] = generateL(conduct_horizonal,conduct_vertical,boundayrate,innerrate)
%GENERATEL 此处显示有关此函数的摘要
%   此处显示详细说明
n = size(conduct_horizonal,1);
